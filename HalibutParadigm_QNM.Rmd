...
model_names <- c("St. Paul", "Savoonga", "Unalaska/Dutch Harbor", "Amendment 80", "Mekoryuk Before", "Mekoryuk After")
...
``` {r out.width = '1000px'}
impact.barplot2(sims$mekoryuk_b, perturb = c("Access to halibut CDQ" = -1), main = "Decrease access to halibut CDQ")
```
