...
# For Saint Paul, Savoonga, and Mekoryuk, the press perturbation = decrease halibut access

f <- press.impact(edges = edges_lim$stpaul, perturb = c("Halibut IFQ" = -1))

sim_responses <- f(solve(sims$stpaul$A[[1]]))

binary <- function(x) { if (x != 0) {x/abs(x)} else {0} }
